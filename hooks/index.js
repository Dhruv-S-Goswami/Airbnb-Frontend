...
export const useProvideAuth = () => {
    ...
    const googleLogin = async (credential) => {
        ...
        try {
            const { data } = await axios.post('http://localhost:4000/user/google/login', {
    ...
    const uploadPicture = async (picture) => {
        try {
            ...
            const { data } = await axios.post('http://localhost:4000/user/upload-picture', formData, {
    ...
    const updateUser = async (userDetails) => {
        ...
        try {
            const { data } = await axios.put('http://localhost:4000/user/update-user', {
...
export const useProvidePlaces = () => {
    ...
    const getPlaces = async () => {
        const { data } = await axios.get('http://localhost:4000/places');
